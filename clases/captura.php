...
//para procesar la informacion de ajax de pago.php
...
//insercion de los detalles de datos a la base de datos (visto con inspeccionar)
if (is_array($datos)) {
    ...
    //para ver lo que esta comprando un cliente
    if ($id > 0) { //variable de sesion
        ...
        //elimina los productos del carrito una vez hecho el pago y al actulizar la pagina del carrito redirije al index
