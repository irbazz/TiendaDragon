...
//para validar la lista de los productos (carrito)
$productos = isset($_SESSION['carrito']['productos']) ? $_SESSION['carrito']['productos'] : null;

//variable para el los elementos del carrito
$lista_carrito = array();
...
//acciones del carrito (agregar y eliminar elementos)
...
<body>
    ...
    <!-- Modal de boostrap para boton eliminar-->
    ...
    <script>
        ...
        //elimina los elementos del carrito mendiante un query js
        ...
        //funcion para eliminar los productos (logica)
        function eliminar() {
